...
<head>
    ...
    <link rel="shortcut icon" href="{{ ('landing-page/images/favicon.ico') }}">
    <!-- Bootstrap CSS -->
...
<body>
        ...
        <div class="shadow">
            ...
            <div class="main-content">
                ...
                <hr/>
        		<p class="text-justify">
                    Q: Apakah nomor pengaduan itu dan apa yang harus saya lakukan terhadap nomor register ini?
                    <br />
        		...
        		<p class="text-justify">
                    ...
                    lebih terjaga sebaiknya Anda memperhatikan hal-hal sebagaimana disebutkan di <a href="bantuan">sini.</a>
                </p>
                <hr>
            </div>
